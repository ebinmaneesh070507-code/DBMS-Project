      ...
      <section className="hero">
        <div>
          <span className="hero-eyebrow-pill">
            <span className="sidebar-status-dot" /> Live across 5 zones
          </span>
          ...
          <div className="hero-stats-row">
            <div>
              <div className="hero-stat-num">48.2t</div>
              <div className="hero-stat-label">Waste tracked this month</div>
            </div>
            <div>
              <div className="hero-stat-num">60.4%</div>
              <div className="hero-stat-label">Recycling rate</div>
            </div>
            <div>
              <div className="hero-stat-num">9</div>
              <div className="hero-stat-label">Bins flagged high-risk</div>
            </div>
          </div>
        </div>
        <HeroVisual />
